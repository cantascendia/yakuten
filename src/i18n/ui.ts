...
export const ui = {
  zh: {
    ...
    'footer.privacy.text': '无需注册、无广告。我们用 Google Analytics（会设置 Cookie）与 Vercel Analytics 统计聚合访问量，但从不发送健康数据、输入内容或 AI 对话。血检记录只保存在你的浏览器。',
  ...
  en: {
    ...
    'footer.privacy.text': 'No accounts, no ads. We use Google Analytics (which sets cookies) and Vercel Analytics for aggregate visit statistics, but never send them health data, your inputs or AI chats. Blood-test records stay in your browser.',
  ...
  ja: {
    ...
    'footer.privacy.text': 'アカウント登録不要・広告なし。アクセスの集計に Google Analytics（Cookie を使用）と Vercel Analytics を使いますが、健康データ・入力内容・AI との会話は送信しません。血液検査の記録はブラウザ内にのみ保存されます。',
  ...
  ko: {
    ...
    'footer.privacy.text': '회원 가입도 광고도 없습니다. 방문 집계에 Google Analytics(쿠키 사용)와 Vercel Analytics를 쓰지만 건강 데이터, 입력 내용, AI 대화는 보내지 않습니다. 혈액검사 기록은 브라우저에만 저장됩니다.',
  ...
  pt: {
    ...
    'footer.privacy.text': 'Sem cadastro e sem anúncios. Usamos o Google Analytics (que grava cookies) e o Vercel Analytics para estatísticas agregadas de visitas, mas nunca enviamos a eles dados de saúde, o que você digita ou conversas com a IA. Registros de exames ficam no seu navegador.',
  ...
  ru: {
    ...
    'footer.privacy.text': 'Без регистрации и рекламы. Для агрегированной статистики посещений мы используем Google Analytics (ставит cookie) и Vercel Analytics, но никогда не передаём им данные о здоровье, ваш ввод или диалоги с ИИ. Записи анализов хранятся в вашем браузере.',
  ...
  es: {
    ...
    'footer.privacy.text': 'Sin cuentas ni anuncios. Usamos Google Analytics (que guarda cookies) y Vercel Analytics para estadísticas agregadas de visitas, pero nunca les enviamos datos de salud, lo que escribes ni tus conversaciones con la IA. Los registros de análisis se quedan en tu navegador.',
  ...
  id: {
    ...
    'footer.privacy.text': 'Tanpa akun, tanpa iklan. Kami memakai Google Analytics (yang menyimpan cookie) dan Vercel Analytics untuk statistik kunjungan agregat, tetapi tidak pernah mengirim data kesehatan, input, atau obrolan AI kepada mereka. Catatan tes darah tetap di peramban Anda.',
  ...
  th: {
    ...
    'footer.privacy.text': 'ไม่ต้องสมัครบัญชี ไม่มีโฆษณา เราใช้ Google Analytics (ซึ่งตั้งคุกกี้) และ Vercel Analytics เพื่อนับสถิติการเข้าชมแบบรวม แต่ไม่ส่งข้อมูลสุขภาพ สิ่งที่คุณป้อน หรือบทสนทนากับ AI ให้บริการเหล่านี้ บันทึกผลเลือดอยู่ในเบราว์เซอร์ของคุณเท่านั้น',
  ...
  hi: {
    ...
    'footer.privacy.text': 'कोई खाता नहीं, कोई विज्ञापन नहीं। समग्र विज़िट आँकड़ों के लिए हम Google Analytics (जो कुकीज़ सेट करता है) और Vercel Analytics का उपयोग करते हैं, लेकिन उन्हें स्वास्थ्य डेटा, आपका इनपुट या AI बातचीत कभी नहीं भेजते। रक्त-परीक्षण रिकॉर्ड आपके ब्राउज़र में ही रहते हैं।',
  ...
  vi: {
    ...
    'footer.privacy.text': 'Không cần tài khoản, không quảng cáo. Chúng tôi dùng Google Analytics (có đặt cookie) và Vercel Analytics để thống kê tổng hợp lượt truy cập, nhưng không bao giờ gửi cho họ dữ liệu sức khỏe, nội dung bạn nhập hay cuộc trò chuyện với AI. Hồ sơ xét nghiệm máu chỉ nằm trong trình duyệt của bạn.',
  ...
  ar: {
    ...
    'footer.privacy.text': 'لا حسابات ولا إعلانات. نستخدم Google Analytics (الذي يضع ملفات تعريف ارتباط) وVercel Analytics لإحصاءات زيارات إجمالية، لكننا لا نرسل إليهما أبدًا بيانات صحية أو ما تُدخله أو محادثات الذكاء الاصطناعي. تبقى سجلات تحاليل الدم في متصفحك.',
  ...
  fa: {
    ...
    'footer.privacy.text': 'بدون حساب کاربری و بدون تبلیغات. برای آمار تجمیعی بازدید از Google Analytics (که کوکی ذخیره می‌کند) و Vercel Analytics استفاده می‌کنیم، اما هرگز داده‌های سلامت، ورودی‌های شما یا گفت‌وگوهای هوش مصنوعی را برایشان نمی‌فرستیم. سوابق آزمایش خون فقط در مرورگر شما می‌ماند.',
  ...
  de: {
    ...
    'footer.privacy.text': 'Kein Konto, keine Werbung. Für aggregierte Besuchsstatistiken nutzen wir Google Analytics (setzt Cookies) und Vercel Analytics, senden ihnen aber nie Gesundheitsdaten, deine Eingaben oder KI-Gespräche. Bluttest-Einträge bleiben in deinem Browser.',
  ...
  tr: {
    ...
    'footer.privacy.text': 'Hesap yok, reklam yok. Toplu ziyaret istatistikleri için Google Analytics (çerez kullanır) ve Vercel Analytics kullanıyoruz, ancak onlara asla sağlık verisi, girdileriniz veya yapay zekâ sohbetleri göndermiyoruz. Kan tahlili kayıtları tarayıcınızda kalır.',
