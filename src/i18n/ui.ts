...
export const ui = {
  zh: {
    ...
    'footer.privacy.text': '无需注册、无广告。我们用 Google Analytics（会设置 Cookie）与 Vercel Analytics 统计聚合访问量，但从不发送健康数据、输入内容或 AI 对话。血检记录只保存在你的浏览器；AI 回答由第三方 AI 服务生成，请勿输入可识别身份的信息。',
    ...
    'footer.brand': 'HRT药典',
    'footer.notice': '本站不提供处方、不销售药物，也无需注册账号。',
  ...
  en: {
    ...
    'footer.privacy.text': 'No accounts, no ads. We use Google Analytics (which sets cookies) and Vercel Analytics for aggregate visit statistics, but never send them health data, your inputs or AI chats. Blood-test records stay in your browser; AI answers come from third-party AI providers, so please leave out identifying details.',
    ...
    'footer.notice': 'This site does not prescribe medications, sell drugs, or require an account.',
  ...
  ja: {
    ...
    'footer.privacy.text': 'アカウント登録不要・広告なし。アクセスの集計に Google Analytics（Cookie を使用）と Vercel Analytics を使いますが、健康データ・入力内容・AI との会話は送信しません。血液検査の記録はブラウザ内にのみ保存されます。AI の回答は外部の AI サービスが生成するため、個人を特定できる情報は入力しないでください。',
    ...
    'footer.brand': 'HRT薬典',
    'footer.notice': '本サイトは処方箋の発行や薬物の販売を行わず、アカウント登録も不要です。',
  ...
  ko: {
    ...
    'footer.privacy.text': '회원 가입도 광고도 없습니다. 방문 집계에 Google Analytics(쿠키 사용)와 Vercel Analytics를 쓰지만 건강 데이터, 입력 내용, AI 대화는 보내지 않습니다. 혈액검사 기록은 브라우저에만 저장됩니다. AI 답변은 외부 AI 서비스가 생성하므로 본인을 식별할 수 있는 정보는 입력하지 마세요.',
    ...
    'footer.brand': 'HRT약전',
    'footer.notice': '이 사이트는 처방전 발급이나 약물 판매를 하지 않으며, 회원 가입도 필요하지 않습니다.',
  ...
  pt: {
    ...
    'footer.privacy.text': 'Sem cadastro e sem anúncios. Usamos o Google Analytics (que grava cookies) e o Vercel Analytics para estatísticas agregadas de visitas, mas nunca enviamos a eles dados de saúde, o que você digita ou conversas com a IA. Registros de exames ficam no seu navegador; as respostas da IA vêm de provedores terceiros, então não inclua dados que identifiquem você.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Este site não prescreve medicamentos, não vende remédios e não exige cadastro.',
  ...
  ru: {
    ...
    'footer.privacy.text': 'Без регистрации и рекламы. Для агрегированной статистики посещений мы используем Google Analytics (ставит cookie) и Vercel Analytics, но никогда не передаём им данные о здоровье, ваш ввод или диалоги с ИИ. Записи анализов хранятся в вашем браузере; ответы ИИ генерируют сторонние сервисы, поэтому не указывайте данные, по которым вас можно узнать.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Этот сайт не выписывает рецепты, не продаёт лекарства и не требует регистрации.',
  ...
  es: {
    ...
    'footer.privacy.text': 'Sin cuentas ni anuncios. Usamos Google Analytics (que guarda cookies) y Vercel Analytics para estadísticas agregadas de visitas, pero nunca les enviamos datos de salud, lo que escribes ni tus conversaciones con la IA. Los registros de análisis se quedan en tu navegador; las respuestas de la IA las generan proveedores externos, así que no incluyas datos que te identifiquen.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Este sitio no receta medicamentos, no vende fármacos ni requiere crear una cuenta.',
  ...
  id: {
    ...
    'footer.privacy.text': 'Tanpa akun, tanpa iklan. Kami memakai Google Analytics (yang menyimpan cookie) dan Vercel Analytics untuk statistik kunjungan agregat, tetapi tidak pernah mengirim data kesehatan, input, atau obrolan AI kepada mereka. Catatan tes darah tetap di peramban Anda; jawaban AI dibuat oleh penyedia AI pihak ketiga, jadi jangan sertakan informasi yang dapat mengenali Anda.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Situs ini tidak meresepkan obat, tidak menjual obat, dan tidak memerlukan akun.',
  ...
  th: {
    ...
    'footer.privacy.text': 'ไม่ต้องสมัครบัญชี ไม่มีโฆษณา เราใช้ Google Analytics (ซึ่งตั้งคุกกี้) และ Vercel Analytics เพื่อนับสถิติการเข้าชมแบบรวม แต่ไม่ส่งข้อมูลสุขภาพ สิ่งที่คุณป้อน หรือบทสนทนากับ AI ให้บริการเหล่านี้ บันทึกผลเลือดอยู่ในเบราว์เซอร์ของคุณเท่านั้น คำตอบ AI สร้างโดยผู้ให้บริการ AI ภายนอก จึงไม่ควรใส่ข้อมูลที่ระบุตัวคุณได้',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'เว็บไซต์นี้ไม่สั่งจ่ายยา ไม่ขายยา และไม่ต้องสมัครบัญชี',
  ...
  fil: {
    ...
    'footer.privacy.title': 'Privacy',
    'footer.privacy.text': 'Walang account, walang ads. Gumagamit kami ng Google Analytics (na naglalagay ng cookies) at Vercel Analytics para sa pinagsama-samang estadistika ng pagbisita, pero hindi kailanman ipinapadala sa kanila ang datos sa kalusugan, ang iyong input o ang mga AI chat. Nananatili sa iyong browser ang mga rekord ng blood test; galing sa mga third-party na AI provider ang mga sagot ng AI, kaya huwag isama ang impormasyong makapagpapakilala sa iyo.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Ang site na ito ay hindi nagrereseta ng gamot, hindi nagbebenta ng gamot, at hindi nangangailangan ng account.',
  ...
  hi: {
    ...
    'footer.privacy.text': 'कोई खाता नहीं, कोई विज्ञापन नहीं। समग्र विज़िट आँकड़ों के लिए हम Google Analytics (जो कुकीज़ सेट करता है) और Vercel Analytics का उपयोग करते हैं, लेकिन उन्हें स्वास्थ्य डेटा, आपका इनपुट या AI बातचीत कभी नहीं भेजते। रक्त-परीक्षण रिकॉर्ड आपके ब्राउज़र में ही रहते हैं; AI उत्तर तृतीय-पक्ष AI प्रदाता तैयार करते हैं, इसलिए पहचान उजागर करने वाली जानकारी न लिखें।',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'यह साइट दवाइयां नहीं लिखती, दवाएं नहीं बेचती और इसके लिए कोई खाता बनाने की ज़रूरत नहीं है।',
  ...
  vi: {
    ...
    'footer.privacy.text': 'Không cần tài khoản, không quảng cáo. Chúng tôi dùng Google Analytics (có đặt cookie) và Vercel Analytics để thống kê tổng hợp lượt truy cập, nhưng không bao giờ gửi cho họ dữ liệu sức khỏe, nội dung bạn nhập hay cuộc trò chuyện với AI. Hồ sơ xét nghiệm máu chỉ nằm trong trình duyệt của bạn; câu trả lời AI do nhà cung cấp AI bên thứ ba tạo ra, vì vậy đừng nhập thông tin có thể nhận ra bạn.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Trang web này không kê đơn thuốc, không bán thuốc và không yêu cầu tạo tài khoản.',
  ...
  ar: {
    ...
    'footer.privacy.text': 'لا حسابات ولا إعلانات. نستخدم Google Analytics (الذي يضع ملفات تعريف ارتباط) وVercel Analytics لإحصاءات زيارات إجمالية، لكننا لا نرسل إليهما أبدًا بيانات صحية أو ما تُدخله أو محادثات الذكاء الاصطناعي. تبقى سجلات تحاليل الدم في متصفحك؛ وتُولَّد إجابات الذكاء الاصطناعي لدى مزوّدين خارجيين، لذا لا تُدرج معلومات تكشف هويتك.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'هذا الموقع لا يصف الأدوية ولا يبيعها، ولا يتطلب إنشاء حساب.',
  ...
  fa: {
    ...
    'footer.privacy.text': 'بدون حساب کاربری و بدون تبلیغات. برای آمار تجمیعی بازدید از Google Analytics (که کوکی ذخیره می‌کند) و Vercel Analytics استفاده می‌کنیم، اما هرگز داده‌های سلامت، ورودی‌های شما یا گفت‌وگوهای هوش مصنوعی را برایشان نمی‌فرستیم. سوابق آزمایش خون فقط در مرورگر شما می‌ماند؛ پاسخ‌های هوش مصنوعی را ارائه‌دهندگان بیرونی تولید می‌کنند، پس اطلاعاتی که هویت شما را آشکار کند وارد نکنید.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'این سایت دارو تجویز نمی‌کند، دارو نمی‌فروشد و نیازی به حساب کاربری ندارد.',
  ...
  fr: {
    ...
    'footer.privacy.text': "Pas de compte, pas de publicité. Nous utilisons Google Analytics (qui dépose des cookies) et Vercel Analytics pour des statistiques de visite agrégées, sans jamais leur envoyer de données de santé, vos saisies ni vos conversations avec l'IA. Les relevés d'analyses restent dans votre navigateur ; les réponses de l'IA sont générées par des fournisseurs tiers, n'y indiquez donc rien qui permette de vous identifier.",
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Ce site ne prescrit pas de médicaments, ne vend pas de médicaments et ne demande aucun compte.',
  ...
  de: {
    ...
    'footer.privacy.text': 'Kein Konto, keine Werbung. Für aggregierte Besuchsstatistiken nutzen wir Google Analytics (setzt Cookies) und Vercel Analytics, senden ihnen aber nie Gesundheitsdaten, deine Eingaben oder KI-Gespräche. Bluttest-Einträge bleiben in deinem Browser; KI-Antworten stammen von externen KI-Anbietern – gib daher nichts ein, was dich identifiziert.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Diese Website verschreibt keine Medikamente, verkauft keine Arzneimittel und erfordert kein Konto.',
  ...
  tr: {
    ...
    'footer.privacy.text': 'Hesap yok, reklam yok. Toplu ziyaret istatistikleri için Google Analytics (çerez kullanır) ve Vercel Analytics kullanıyoruz, ancak onlara asla sağlık verisi, girdileriniz veya yapay zekâ sohbetleri göndermiyoruz. Kan tahlili kayıtları tarayıcınızda kalır; yapay zekâ yanıtlarını üçüncü taraf sağlayıcılar üretir, bu yüzden sizi tanımlayabilecek bilgiler yazmayın.',
    ...
    'footer.brand': 'HRT Yakuten',
    'footer.notice': 'Bu site ilaç reçete etmez, ilaç satmaz ve hesap oluşturmanızı gerektirmez.',
