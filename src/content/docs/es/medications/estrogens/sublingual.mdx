...
<img src="/images/diagrams/es/sublingual-placement.webp" alt="Diagrama de colocación del comprimido sublingual que muestra la posición correcta debajo de la lengua" width="800" height="450" loading="lazy" decoding="async" style="width:100%;height:auto;border-radius:4px;margin:0 0 var(--space-lg);" />
...
Existe una frustrante falta de datos clínicos a gran escala que relacionen el riesgo de TEV específicamente con la dosificación sublingual<CitationRef id="canonico-2018" num={4} authors="Canonico M et al." year={2018} title="Estrogen therapy and venous thromboembolism: an updated meta-analysis" />:
