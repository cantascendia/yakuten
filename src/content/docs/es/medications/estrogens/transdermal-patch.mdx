...
<DrugInfoBox
  ...
  nameCN="Parche transdérmico de estradiol"
  category="estrogen"
  route="Transdérmica"
  evidenceLevel="A"
>
...
La dosis máxima estándar es de **400 µg/día**, reservada históricamente para la monoterapia (suprimir la testosterona sin antiandrógenos). La gran mayoría de las usuarias alcanza su rango clínico objetivo de E2 (100-200 pg/mL) con 100-200 µg/día<CitationRef id="hembree-2017" num={3} authors="Hembree WC et al." year={2017} />. Subir el E2 por encima de 200 pg/mL no te feminiza más rápido: solo amplifica los riesgos para tu salud.
</WarningBox>
