...
| Asesoría legal | Cumplimiento de las normas de prescripción en China continental, normativa de privacidad y cómo viajar al extranjero llevando la medicación |
...
**Próximos pasos**: Estamos contactando con médicas y médicos con licencia y aliados de las personas trans en China continental, Hong Kong / Macao / Taiwán, Japón y Norteamérica para sumarse a un grupo rotativo de revisión. Si te interesa, escríbenos a través del [formulario de comentarios](https://wj.qq.com/s2/16576000/5fe5/) o de GitHub.
