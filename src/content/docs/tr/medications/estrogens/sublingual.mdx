...
description: "Estradiolün dil altına alınmasına dair farmakolojik özellikler, biyoyararlanım, kan düzeyindeki büyük dalgalanmalar, doz önerileri ve dikkat edilmesi gereken noktalar."
evidenceLevel: B
...
Dilin altında eritildiğinde estradiol, dil altındaki yoğun kılcal damar ağı sayesinde doğrudan sistemik dolaşıma geçer<CitationRef id="price-1997" num={1} authors="Price TM et al." year={1997} title="Sublingual estradiol pharmacokinetics" />:
...
### Kan Düzeyi Profilleri (Hız Treni)
...
Dilaltı dozlamanın en büyük dezavantajı, **kan düzeylerindeki ciddi kararsızlıktır**. Tablet eridikten sonra E2 düzeyleri patlama gibi yükselir, ama birkaç saat sonra dibe vurur. Bu da şu anlama gelir:

- Tek bir kan testi, günlük ortalama E2 düzeyinizi yansıtamaz.
- Doruk noktasında E2, güvenli hedef aralığının çok üzerine fırlar; dip noktasında ise (bir sonraki dozunuzdan hemen önce) terapötik düzeylerin altına inebilirsiniz.
- Bu hız treni; ruh hâli iniş çıkışlarını, ateş basmalarını, yorgunluğu ve diğer menopoz benzeri belirtileri tetikleyebilir.
...
Kan tahlili yaptırırken, DAİMA bir sonraki dozunuzdan **hemen önce** test yaptırın (dip düzeyi) ve günlük ortalamanızın bunun epeyce üzerinde olduğunu aklınızda tutun.
</WarningBox>
...
Biyoyararlanımın belirgin biçimde artması nedeniyle, etkili dilaltı doz teknik olarak eşdeğer oral dozdan daha düşüktür<CitationRef id="hembree-2017" num={3} authors="Hembree WC et al." year={2017} title="Endocrine Treatment of Gender-Dysphoric/Gender-Incongruent Persons" />:
...
Dilaltı dozlama, **günde 2 ila 3 kez** uygulamayı zorunlu kılar ve dozların mantıklı biçimde aralıklandırılması gerekir (günde iki kez için her 8-12 saatte bir; günde üç kez için her 6-8 saatte bir). Bir dozu unutmak ya da düzensiz almak, zaten acımasız olan kan düzeyi dalgalanmalarını daha da kötüleştirir. Tablet eritmek için çalar saat kurmak yaşamınızı aksatıyorsa, standart oral yola veya transdermal yamalara geçin.
</WarningBox>
