...
VTE riskini özellikle dilaltı dozlamayla ilişkilendiren geniş ölçekli klinik veriler can sıkıcı biçimde eksiktir<CitationRef id="canonico-2018" num={4} authors="Scarabin PY" year={2018} title="Estrogen therapy and venous thromboembolism: an updated meta-analysis" />:
