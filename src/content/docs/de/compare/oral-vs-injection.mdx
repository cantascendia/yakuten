...
Orales Estradiol (Progynova / Estradiolvalerat-Tabletten) und intramuskuläres Estradiolvalerat (EV) als Injektion sind die beiden Applikationswege, die in der chinesischsprachigen MTF-Community am häufigsten zum Einsatz kommen. Diese Seite stellt Pharmakokinetik, Sicherheit und praktische Hürden nebeneinander – **ohne eine pauschale Empfehlung abzugeben**.
...
**Das absolute Risiko bleibt dabei weiterhin niedrig**: Das VTE-Ausgangsrisiko bei jungen, gesunden MTF-Anwenderinnen liegt bei ~1-2/1000 Personenjahren. Rauchen, Adipositas und ein Alter über 40 summieren sich und erhöhen das absolute Risiko erheblich.
