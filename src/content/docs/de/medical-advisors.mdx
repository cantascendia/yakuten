...
**Nächste Schritte**: Wir treten an trans-freundliche approbierte Ärzt:innen in Deutschland, Österreich, der Schweiz und weiteren Regionen heran, um einen rotierenden Prüfpool aufzubauen. Bei Interesse erreichst du uns über [GitHub Issues](https://github.com/cantascendia/yakuten/issues) oder per E-Mail an hi@hrtyaku.com.
...
<WarningBox>
**Diese Seite ersetzt keine medizinische Versorgung**. Für eine individuelle Diagnose und Behandlung wende dich an eine qualifizierte Ärzt:in in deiner Region. Die Website stellt **evidenzbasierte Informationen** bereit und ist keine Verschreibung und keine individuelle Beratung.
</WarningBox>
