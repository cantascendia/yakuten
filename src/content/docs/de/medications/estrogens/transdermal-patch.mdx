...
<DrugInfoBox
  name="Transdermales Estradiolpflaster (Estramon, Climara)"
  nameCN="Estradiolpflaster"
  category="estrogen"
  route="Transdermal"
  evidenceLevel="A"
>
...
Die übliche Höchstdosis liegt bei **400 µg/Tag** und kam historisch nur bei einer Monotherapie zum Einsatz (Unterdrückung von Testosteron ohne Antiandrogene). Die allermeisten Anwenderinnen erreichen ihren klinischen Ziel-E2-Bereich (100-200 pg/mL) bereits mit 100-200 µg/Tag<CitationRef id="hembree-2017" num={3} authors="Hembree WC et al." year={2017} />. E2 über 200 pg/mL zu treiben, feminisiert nicht schneller, sondern verstärkt nur die gesundheitlichen Risiken.
</WarningBox>
