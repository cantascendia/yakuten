---
title: "Metodologi"
description: "Bagaimana konten HRT Pharmacopoeia diproduksi, dari penelusuran literatur hingga publikasi — penyelarasan dengan pedoman klinis, sitasi DOI, penilaian bukti A/B/C/X, pemeriksaan silang dua orang, telaah penasihat medis, dan telaah berkala setiap kuartal."
evidenceLevel: X
...
1. **Tidak ada klaim tanpa sitasi**: setiap klaim medis harus disertai setidaknya satu rujukan DOI atau pedoman internasional; jika sebuah klaim tidak dapat ditelusuri sumbernya, klaim tersebut ditandai sebagai <EvidenceBadge level="X" /> atau dihapus.
