...
As vias transdérmicas (adesivos e gel) apresentam um risco de TEV estatisticamente idêntico ao de pessoas que não fazem TH (RR ≈ 0.97). Em contrapartida, a administração oral aumenta o risco em cerca de 48% (RR ≈ 1.48). Se você tiver qualquer fator de risco prévio para TEV, a via transdérmica deve ser sua primeira escolha absoluta<CitationRef id="canonico-2018" num={1} authors="Canonico M et al." year={2018} />.
</WarningBox>
