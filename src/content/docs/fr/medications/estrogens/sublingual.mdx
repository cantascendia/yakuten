...
On déplore un manque criant de données cliniques à grande échelle reliant spécifiquement le risque de VTE à la voie sublinguale<CitationRef id="canonico-2018" num={4} authors="Scarabin PY" year={2018} title="Estrogen therapy and venous thromboembolism: an updated meta-analysis" /> :
