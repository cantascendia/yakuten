...
<img src="/images/diagrams/fr/routes-comparison.webp" alt="Comparaison des trois voies d'administration de l'estradiol : voie orale via le foie, absorption transdermique directe, injection dans la circulation sanguine" width="800" height="450" loading="lazy" decoding="async" style="width:100%;height:auto;border-radius:4px;margin:var(--space-md) 0 var(--space-lg);" />

## Risque de TEV selon la voie d'administration

La thromboembolie veineuse (caillots sanguins) figure parmi les risques les plus graves associés à l'œstrogénothérapie. Ce risque varie considérablement selon la façon dont l'œstrogène pénètre dans l'organisme<CitationRef id="canonico-2018" num={1} authors="Canonico M et al." year={2018} title="Estrogen therapy and venous thromboembolism: an updated meta-analysis" />.
...
Les voies transdermiques (patch et gel) présentent un risque de TEV statistiquement identique à celui des personnes ne prenant pas de THS (RR ≈ 0.97). À l'inverse, la voie orale augmente ce risque d'environ 48 % (RR ≈ 1.48). Si vous présentez un quelconque facteur de risque préexistant de TEV, une voie transdermique devrait être votre tout premier choix<CitationRef id="canonico-2018" num={1} authors="Canonico M et al." year={2018} />.
</WarningBox>
