...
Les patchs transdermiques présentent le risque de MTEV le plus faible de toutes les voies d'administration de l'estradiol<CitationRef id="canonico-2018" num={2} authors="Canonico M et al." year={2018} title="Estrogen therapy and venous thromboembolism: an updated meta-analysis" /> :
...
Un **RR ≈ 0.97** signifie, en pratique, que le recours aux patchs transdermiques ne comporte aucune augmentation statistiquement significative du risque de MTEV par rapport aux personnes ne suivant aucune œstrogénothérapie<CitationRef id="canonico-2018" num={2} authors="Canonico M et al." year={2018} />. Cela consacre le patch comme le premier choix incontournable pour toute personne présentant des facteurs de risque thrombotique préexistants.
