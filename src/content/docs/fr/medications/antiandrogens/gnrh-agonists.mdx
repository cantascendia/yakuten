...
Les agonistes de la GnRH agissent à un niveau fondamentalement différent des autres anti-androgènes : ils ciblent le centre de contrôle en amont de la production hormonale<CitationRef id="hembree-2017" num={1} authors="Hembree WC et al." year={2017} title="Endocrine Treatment of Gender-Dysphoric/Gender-Incongruent Persons" /> :
...
Le Zoladex utilise une seringue épaisse préchargée (environ 16G) qui implante une pastille-dépôt solide sous la graisse abdominale. Elle doit toujours être administrée par un(e) professionnel(le) de santé.
</WarningBox>
...
Le pic initial de testostérone (effet « flare », ou poussée) survenant après la première injection d'un agoniste de la GnRH est une réponse pharmacologique normale<CitationRef id="hembree-2017" num={1} authors="Hembree WC et al." year={2017} />.
...
Pour atténuer les symptômes du « flare » lors de la première injection, vous pouvez débuter une cure courte d'anti-androgène simultanément ou 1 semaine avant<CitationRef id="coleman-2022" num={2} authors="Coleman E et al." year={2022} /> :

- **CPA 12.5mg/jour** pendant 2-4 semaines, puis arrêt une fois le « flare » résolu
- **Spironolactone 100mg/jour** pendant 2-4 semaines (si la CPA ne convient pas)
- Si vous êtes déjà sous estradiol, le retentissement clinique du « flare » est généralement modéré
- Les injections ultérieures ne provoquent pas de nouveau « flare » (première injection uniquement)
</WarningBox>
...
- **Recommandés par les recommandations** : avalisés à la fois par ES 2017 et la WPATH SOC 8<CitationRef id="coleman-2022" num={2} authors="Coleman E et al." year={2022} />
