---
title: "Drospirénone"
description: "La drospirénone dans le THS transféminin — un progestatif aux propriétés anti-androgéniques et anti-minéralocorticoïdes."
evidenceLevel: C
sidebar:
  order: 4
...
La plupart des produits contenant de la drospirénone sont des contraceptifs oraux combinés (par ex. Yaz, Yasmin) qui contiennent de l'**éthinylestradiol (EE)**. Ce site [interdit explicitement](/fr/medications/banned-drugs/) l'éthinylestradiol dans le THS. Si vous choisissez la drospirénone, vous devez utiliser une **formulation à base de drospirénone seule** (par ex. Slynd 4 mg), et non un produit combiné contenant de l'EE.
</WarningBox>
...
- **Ne doit pas être associée à la spironolactone** : toutes deux ont un effet épargneur de potassium ; l'association peut provoquer une hyperkaliémie dangereuse<CitationRef id="hembree-2017" num={2} authors="Hembree WC et al." year={2017} title="Endocrine Treatment of Gender-Dysphoric/Gender-Incongruent Persons" />
- **Ne pas utiliser de formulations contenant de l'EE** (Yaz/Yasmin, etc.)
- À utiliser avec prudence en cas d'insuffisance rénale
- Il n'existe aucune donnée de sécurité à grande échelle concernant la drospirénone dans le THS transgenre
</DangerBox>
