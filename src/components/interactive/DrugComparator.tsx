...
const UI_COPY = {
  ...
  ko: {
    ...
    vteRR: '상대 위험 (RR)',
    evidenceLevel: '근거 수준',
    monitoringTests: '모니터링 항목',
    contraindications: '절대 금기',
    catEstrogen: '에스트로겐',
    catAntiandrogen: '항안드로겐',
    catProgestogen: '프로게스토겐',
    riskLow: '낮음',
    riskModerate: '중간',
    riskHigh: '높음',
    riskVeryHigh: '매우 높음',
    cat5ari: '5α-환원효소 억제제',
    disclaimer: '이 도구는 약물 특성 비교 참고용이며, 의학적 조언이 아닙니다. 개별 상황은 의료 전문가와 상담하세요.',
  },
} as const;
...
interface DrugCompare {
  id: string;
  names: { zh: string; en: string; ja: string; ko: string };
  category: 'estrogen' | 'antiandrogen' | 'progestogen' | '5ari';
  route: { zh: string; en: string; ja: string; ko: string };
  doseStart: string;
  doseMaintenance: string;
  doseMax: string;
  frequency: { zh: string; en: string; ja: string; ko: string };
  halfLife: string;
  bioavailability: string;
  vteRR: number;
  evidenceLevel: string;
  monitoring: string[];
  contraindications: { zh: string[]; en: string[]; ja: string[]; ko: string[] };
}

const DRUGS: DrugCompare[] = [
  {
    id: 'estradiol-oral',
    names: { zh: '口服雌二醇', en: 'Oral Estradiol', ja: '経口エストラジオール', ko: '경구 에스트라디올' },
    category: 'estrogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '2 mg/天',
    doseMaintenance: '2–4 mg/天',
    doseMax: '10 mg/天',
    frequency: { zh: '每日1-2次', en: '1-2x daily', ja: '1日1-2回', ko: '1일 1-2회' },
    halfLife: '12–20h',
    bioavailability: '~5%',
    vteRR: 1.48,
    evidenceLevel: 'A',
    ...
    contraindications: {
      ...
      ko: ['활동성 DVT/PE', '응고 장애', '에스트로겐 의존성 종양', '중증 간 질환'],
    },
  },
  {
    id: 'estradiol-sublingual',
    names: { zh: '舌下含服雌二醇', en: 'Sublingual Estradiol', ja: '舌下エストラジオール', ko: '설하 에스트라디올' },
    category: 'estrogen',
    route: { zh: '舌下含服', en: 'Sublingual', ja: '舌下', ko: '설하' },
    doseStart: '1–2 mg/天',
    doseMaintenance: '2–4 mg/天',
    doseMax: '8 mg/天',
    frequency: { zh: '每日2-4次', en: '2-4x daily', ja: '1日2-4回', ko: '1일 2-4회' },
    halfLife: '6–8h',
    bioavailability: '~25%',
    vteRR: 1.48,
    evidenceLevel: 'B',
    ...
    contraindications: {
      ...
      ko: ['활동성 DVT/PE', '응고 장애', '에스트로겐 의존성 종양'],
    },
  },
  {
    id: 'estradiol-patch',
    names: { zh: '雌二醇贴片', en: 'Estradiol Patch', ja: 'エストラジオール貼付剤', ko: '에스트라디올 패치' },
    category: 'estrogen',
    route: { zh: '经皮（贴片）', en: 'Transdermal (patch)', ja: '経皮（パッチ）', ko: '경피 (패치)' },
    doseStart: '50 µg/天',
    doseMaintenance: '100–200 µg/天',
    doseMax: '400 µg/天',
    frequency: { zh: '每3.5天更换', en: 'Every 3.5 days', ja: '3.5日ごと交換', ko: '3.5일마다 교체' },
    halfLife: '—',
    bioavailability: '~10%',
    vteRR: 0.97,
    evidenceLevel: 'A',
    ...
    contraindications: {
      ...
      ko: ['패치 알레르기', '손상된 피부', '에스트로겐 의존성 종양'],
    },
  },
  {
    id: 'estradiol-gel',
    names: { zh: '雌二醇凝胶', en: 'Estradiol Gel', ja: 'エストラジオールゲル', ko: '에스트라디올 젤' },
    category: 'estrogen',
    route: { zh: '经皮（凝胶）', en: 'Transdermal (gel)', ja: '経皮（ゲル）', ko: '경피 (젤)' },
    doseStart: '1.5 mg/天',
    doseMaintenance: '1.5–3 mg/天',
    doseMax: '6 mg/天',
    frequency: { zh: '每日1次', en: 'Once daily', ja: '1日1回', ko: '1일 1회' },
    halfLife: '—',
    bioavailability: '~10%',
    vteRR: 0.97,
    evidenceLevel: 'B',
    ...
    contraindications: {
      ...
      ko: ['젤 성분 알레르기', '에스트로겐 의존성 종양'],
    },
  },
  {
    id: 'estradiol-injection',
    names: { zh: '戊酸雌二醇注射', en: 'Estradiol Valerate (IM/SC)', ja: 'エストラジオール吉草酸エステル注射', ko: '발레르산 에스트라디올 주사' },
    category: 'estrogen',
    route: { zh: '肌注/皮下', en: 'IM / SC injection', ja: '筋注/皮下注射', ko: '근육/피하 주사' },
    doseStart: '2–4 mg',
    doseMaintenance: '4–6 mg',
    doseMax: '10 mg',
    frequency: { zh: '每4-7天', en: 'Every 4-7 days', ja: '4-7日ごと', ko: '4-7일마다' },
    halfLife: '4–5 天',
    bioavailability: '~100%',
    vteRR: 1.0,
    evidenceLevel: 'A',
    ...
    contraindications: {
      ...
      ko: ['주사 부위 감염', '응고 장애 (상대적)', '에스트로겐 의존성 종양'],
    },
  },
  {
    id: 'cpa',
    names: { zh: '醋酸环丙孕酮 (CPA)', en: 'Cyproterone Acetate (CPA)', ja: '酢酸シプロテロン (CPA)', ko: '시프로테론 아세테이트 (CPA)' },
    category: 'antiandrogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '5–12.5 mg/天',
    doseMaintenance: '5–12.5 mg/天',
    doseMax: '12.5 mg/天',
    frequency: { zh: '每日或隔日', en: 'Daily or every other day', ja: '毎日または隔日', ko: '매일 또는 격일' },
    halfLife: '1.5–4 天',
    bioavailability: '~100%',
    vteRR: 2.0,
    evidenceLevel: 'A',
    ...
    contraindications: {
      ...
      ko: ['수막종 (현재 또는 과거)', '중증 간 질환', '중증 미치료 우울증'],
    },
  },
  {
    id: 'spironolactone',
    names: { zh: '螺内酯', en: 'Spironolactone', ja: 'スピロノラクトン', ko: '스피로노락톤' },
    category: 'antiandrogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '50 mg/天',
    ...
    contraindications: {
      ...
      ko: ['고칼륨혈증', '중증 신부전', '애디슨병'],
    },
  },
  {
    id: 'bicalutamide',
    names: { zh: '比卡鲁胺', en: 'Bicalutamide', ja: 'ビカルタミド', ko: '비칼루타미드' },
    category: 'antiandrogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
  ...
  {
    id: 'gnrh-agonist',
    names: { zh: 'GnRH 激动剂', en: 'GnRH Agonist', ja: 'GnRHアゴニスト', ko: 'GnRH 작용제' },
    category: 'antiandrogen',
    route: { zh: '注射（缓释）', en: 'Injection (depot)', ja: '注射（デポ剤）', ko: '주사 (서방형)' },
    doseStart: '3.75 mg/月',
    doseMaintenance: '3.75 mg/月 或 11.25 mg/3月',
    doseMax: '11.25 mg/3月',
    frequency: { zh: '每月或每3月', en: 'Monthly or every 3 months', ja: '毎月または3ヶ月ごと', ko: '매월 또는 3개월마다' },
  ...
  {
    id: 'progesterone',
    names: { zh: '微粒化黄体酮', en: 'Micronized Progesterone', ja: '微粒化プロゲステロン', ko: '미세화 프로게스테론' },
    category: 'progestogen',
    route: { zh: '口服/直肠', en: 'Oral / Rectal', ja: '経口/直腸', ko: '경구/직장' },
    doseStart: '100 mg/天',
    doseMaintenance: '100–200 mg/天',
    doseMax: '200 mg/天',
    frequency: { zh: '每晚睡前', en: 'Nightly', ja: '就寝前', ko: '취침 전 매일 밤' },
    halfLife: '16–18h',
    ...
    contraindications: {
      ...
      ko: ['땅콩 알레르기 (땅콩 오일 함유)', '중증 간 질환'],
    },
  },
  {
    id: 'hydroxyprogesterone',
    names: { zh: '己酸羟孕酮', en: 'Hydroxyprogesterone Caproate', ja: 'カプロン酸ヒドロキシプロゲステロン', ko: '하이드록시프로게스테론 카프로에이트' },
    category: 'progestogen',
    route: { zh: '肌注', en: 'IM injection', ja: '筋注', ko: '근육 주사' },
    doseStart: '125–250 mg',
    doseMaintenance: '250 mg',
    doseMax: '500 mg',
    frequency: { zh: '每1-2周', en: 'Every 1-2 weeks', ja: '1-2週ごと', ko: '1-2주마다' },
    halfLife: '7–8 天',
    bioavailability: '~100%',
    vteRR: 1.0,
    evidenceLevel: 'C',
  ...
  },
  {
    ...
    names: { zh: '环戊丙酸雌二醇注射', en: 'Estradiol Cypionate (IM/SC)', ja: 'エストラジオールシピオネート注射', ko: '에스트라디올 시피오네이트 주사' },
    category: 'estrogen',
    route: { zh: '肌注/皮下', en: 'IM / SC injection', ja: '筋注/皮下注射', ko: '근육/피하 주사' },
    doseStart: '2-3 mg/周',
    doseMaintenance: '3-5 mg/周',
    doseMax: '7 mg/10-14天',
    frequency: { zh: '每7-14天', en: 'Every 7-14 days', ja: '7-14日ごと', ko: '7-14일마다' },
    halfLife: '8-10 天',
    bioavailability: '~100%',
    vteRR: 1.0,
    evidenceLevel: 'B',
    ...
    contraindications: {
      ...
      ko: ['활동성 DVT/PE', '에스트로겐 의존성 종양'],
    },
  },
  {
    id: 'estradiol-enanthate',
    names: { zh: '庚酸雌二醇注射', en: 'Estradiol Enanthate (IM/SC)', ja: 'エストラジオールエナント酸エステル注射', ko: '에스트라디올 에난테이트 주사' },
    category: 'estrogen',
    route: { zh: '肌注/皮下', en: 'IM / SC injection', ja: '筋注/皮下注射', ko: '근육/피하 주사' },
    doseStart: '2-4 mg/周',
    doseMaintenance: '4-6 mg/周',
    doseMax: '10 mg/10天',
    frequency: { zh: '每7-10天', en: 'Every 7-10 days', ja: '7-10日ごと', ko: '7-10일마다' },
    halfLife: '5-7 天',
    bioavailability: '~100%',
    vteRR: 1.0,
    evidenceLevel: 'B',
  ...
  },
  {
    ...
    names: { zh: '十一酸雌二醇注射', en: 'Estradiol Undecylate (IM)', ja: 'ウンデシル酸エストラジオール注射', ko: '에스트라디올 운데실레이트 주사' },
    category: 'estrogen',
    route: { zh: '肌注', en: 'IM injection', ja: '筋注', ko: '근육 주사' },
    doseStart: '20-40 mg/月',
    doseMaintenance: '40-100 mg/月',
    doseMax: '100 mg/月',
    frequency: { zh: '每21-30天', en: 'Every 21-30 days', ja: '21-30日ごと', ko: '21-30일마다' },
    halfLife: '20-30 天',
    bioavailability: '~100%',
    vteRR: 1.0,
    evidenceLevel: 'C',
  ...
  {
    id: 'finasteride',
    names: { zh: '非那雄胺', en: 'Finasteride', ja: 'フィナステリド', ko: '피나스테리드' },
    category: '5ari',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '1 mg/天',
    ...
    contraindications: {
      ...
      ja: ['薬物アレルギー', '重度肝機能障害'],
      ko: ['약물 알레르기', '중증 간기능 장애'],
    },
  },
  {
    id: 'dutasteride',
    names: { zh: '度他雄胺', en: 'Dutasteride', ja: 'デュタステリド', ko: '두타스테리드' },
    category: '5ari',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '0.5 mg/天',
    ...
    contraindications: {
      ...
      ko: ['약물 알레르기', '중증 간기능 장애', '강력한 CYP3A4 억제제 병용'],
    },
  },
  {
    id: 'dydrogesterone',
    names: { zh: '地屈孕酮', en: 'Dydrogesterone', ja: 'ジドロゲステロン', ko: '디드로게스테론' },
    category: 'progestogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '10 mg/天',
    ...
    contraindications: {
      ...
      ko: ['약물 알레르기', '급성 간성 포르피린증'],
    },
  },
  {
    id: 'drospirenone',
    names: { zh: '屈螺酮', en: 'Drospirenone', ja: 'ドロスピレノン', ko: '드로스피레논' },
    category: 'progestogen',
    route: { zh: '口服', en: 'Oral', ja: '経口', ko: '경구' },
    doseStart: '3-4 mg/天',
...
const PRESETS = [
  { a: 'cpa', b: 'spironolactone', label: { zh: 'CPA vs 螺内酯', en: 'CPA vs Spiro', ja: 'CPA vs スピロ', ko: 'CPA vs 스피로' } },
  { a: 'estradiol-oral', b: 'estradiol-injection', label: { zh: '口服 vs 注射', en: 'Oral vs Injection', ja: '経口 vs 注射', ko: '경구 vs 주사' } },
  { a: 'estradiol-patch', b: 'estradiol-gel', label: { zh: '贴片 vs 凝胶', en: 'Patch vs Gel', ja: 'パッチ vs ゲル', ko: '패치 vs 젤' } },
  { a: 'progesterone', b: 'dydrogesterone', label: { zh: '黄体酮 vs 地屈孕酮', en: 'Progesterone vs Dydro', ja: 'プロゲステロン vs ジドロ', ko: '프로게스테론 vs 디드로' } },
] as const;
