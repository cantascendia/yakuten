  ...
  integrations: [
    starlight({
      ...
      sidebar: [
        ...
        {
          label: '开始',
          translations: { en: 'Getting Started', ja: 'はじめに', ko: '시작하기', pt: 'Primeiros Passos' },
          items: [
            {
              label: '用药前准备',
              translations: { en: 'Before You Start', ja: '服薬前の準備', ko: '복용 전 준비', pt: 'Antes de Começar' },
              slug: 'before-you-start',
            },
            {
              label: '中国 HRT 现实路径图',
              translations: { en: 'China HRT Guide', ja: '中国HRTガイド', ko: '중국 HRT 가이드', pt: 'Guia de TH na China' },
              slug: 'china-reality',
            },
            {
              label: '用药路径图',
              translations: { en: 'HRT Pathway', ja: 'HRT経路マップ', ko: 'HRT 경로 맵', pt: 'Caminho da TH' },
              slug: 'pathway',
            },
          ],
        },
        ...
        {
          label: '安全底线',
          translations: { en: 'Safety Baseline', ja: '安全基準', ko: '안전 기준', pt: 'Linha de Segurança' },
          items: [
            {
              label: '风险与急症识别',
              translations: { en: 'Risks & Emergencies', ja: 'リスクと緊急対応', ko: '위험 및 응급 상황', pt: 'Riscos e Emergências' },
              slug: 'risks',
              badge: { text: { 'zh-CN': '必读', en: 'Must Read', ja: '必読', ko: '필독', pt: 'Leitura Obrigatória' }, variant: 'danger' },
            },
            {
              label: '剂量红线与混用禁忌',
              translations: { en: 'Dose Limits & Contraindications', ja: '用量レッドライン', ko: '용량 한계 및 금기', pt: 'Limites de Dose e Contraindicações' },
              slug: 'dose-limits',
            },
            {
              label: '血检指南与自查工具',
              translations: { en: 'Blood Tests & Self-Check', ja: '血液検査ガイド', ko: '혈액 검사 가이드', pt: 'Exames de Sangue e Autoverificação' },
              slug: 'blood-tests',
            },
            {
              label: '乳房发育专题',
              translations: { en: 'Breast Development', ja: '乳房発育ガイド', ko: '유방 발달 가이드', pt: 'Desenvolvimento Mamário' },
            ...
            },
            {
              ...
              badge: { text: { 'zh-CN': '新', en: 'New', ja: '新', ko: '새', pt: 'Novo' }, variant: 'success' },
            },
          ],
        },
        // ── 实操指南 ──
        {
          label: '实操指南',
          translations: { en: 'Task Guides', ja: '実用ガイド', ko: '실용 가이드', pt: 'Guias Práticos' },
          items: [
            { label: '总览', translations: { en: 'Overview', ja: '概要', ko: '개요', pt: 'Visão Geral' }, slug: 'guides' },
            { label: '首次注射', translations: { en: 'First Injection', ja: '初回注射', ko: '첫 주사', pt: 'Primeira Aplicação' }, slug: 'guides/first-injection' },
            { label: '抗雄切换', translations: { en: 'Switch Antiandrogen', ja: '抗アンドロゲン切り替え', ko: '항안드로겐 전환', pt: 'Trocar de Antiandrógeno' }, slug: 'guides/switch-antiandrogen' },
            { label: '切换 E2 途径', translations: { en: 'Switch E2 Route', ja: 'E2 投与経路の切り替え', ko: 'E2 투여 경로 전환', pt: 'Trocar a Via de E2' }, slug: 'guides/switch-e2-route' },
          ],
        },
        // ── 药物详解 ──
        {
          label: '药物详解',
          translations: { en: 'Medications', ja: '薬物ガイド', ko: '약물 가이드', pt: 'Medicamentos' },
          items: [
            // ── 雌二醇：去掉途径中间层，直接列药物 ──
            {
              label: '雌二醇',
              translations: { en: 'Estrogens', ja: 'エストロゲン', ko: '에스트로겐', pt: 'Estrogênios' },
              items: [
                {
                  label: '总览与选择指南',
                  translations: { en: 'Overview & Selection', ja: '概要と選び方', ko: '개요 및 선택 가이드', pt: 'Visão Geral e Escolha' },
                  slug: 'medications/estrogens/overview',
                },
                {
                  label: '口服（补佳乐）',
                  translations: { en: 'Oral (Pills)', ja: '経口（飲み薬）', ko: '경구 (알약)', pt: 'Oral (Comprimidos)' },
                  slug: 'medications/estrogens/oral',
                  badge: { text: { 'zh-CN': '常用', en: 'Common', ja: '基本', ko: '일반', pt: 'Comum' }, variant: 'tip' },
                },
                {
                  label: '舌下含服',
                  translations: { en: 'Sublingual', ja: '舌下投与', ko: '설하 투여', pt: 'Sublingual' },
                  slug: 'medications/estrogens/sublingual',
                },
                {
                  label: '凝胶',
                  translations: { en: 'Gel', ja: 'ゲル', ko: '겔', pt: 'Gel' },
                  slug: 'medications/estrogens/gel',
                },
                {
                  label: '贴片',
                  translations: { en: 'Patches', ja: 'パッチ', ko: '패치', pt: 'Adesivos' },
                  slug: 'medications/estrogens/transdermal-patch',
                },
                {
                  label: '戊酸雌二醇注射 (EV)',
                  translations: { en: 'Estradiol Valerate (EV)', ja: '吉草酸エストラジオール (EV)', ko: '에스트라디올 발레레이트 (EV)', pt: 'Valerato de Estradiol (EV)' },
                  slug: 'medications/estrogens/injection',
                  badge: { text: { 'zh-CN': '常用', en: 'Common', ja: '基本', ko: '일반', pt: 'Comum' }, variant: 'tip' },
                },
                {
                  label: '其他注射酯类',
                  translations: { en: 'Other Injectable Esters', ja: 'その他の注射エステル', ko: '기타 주사 에스테르', pt: 'Outros Ésteres Injetáveis' },
                  collapsed: true,
                  items: [
                    {
                      label: '环戊丙酸酯 (EC)',
                      translations: { en: 'Estradiol Cypionate (EC)', ja: 'シピオネート (EC)', ko: '시피오네이트 (EC)', pt: 'Cipionato de Estradiol (EC)' },
                      slug: 'medications/estrogens/cypionate',
                    },
                    {
                      label: '庚酸酯 (EEn)',
                      translations: { en: 'Estradiol Enanthate (EEn)', ja: 'エナント酸 (EEn)', ko: '에난테이트 (EEn)', pt: 'Enantato de Estradiol (EEn)' },
                      slug: 'medications/estrogens/enanthate',
                    },
                    {
                      label: '十一酸酯 (EU)',
                      translations: { en: 'Estradiol Undecylate (EU)', ja: 'ウンデシル酸 (EU)', ko: '운데실레이트 (EU)', pt: 'Undecilato de Estradiol (EU)' },
                ...
                {
                  label: '禁用雌激素',
                  translations: { en: 'Banned Estrogens', ja: '禁止エストロゲン', ko: '금지 에스트로겐', pt: 'Estrogênios Proibidos' },
            ...
            {
              label: '抗雄激素',
              translations: { en: 'Anti-Androgens', ja: '抗アンドロゲン', ko: '항안드로겐', pt: 'Antiandrógenos' },
              items: [
                {
                  label: '概述',
                  translations: { en: 'Overview', ja: '概要', ko: '개요', pt: 'Visão Geral' },
                  slug: 'medications/antiandrogens/overview',
                },
                {
                  label: 'CPA（色谱龙）',
                  translations: { en: 'CPA (Cyproterone)', ja: 'CPA（酢酸シプロテロン）', ko: 'CPA (시프로테론)', pt: 'CPA (Ciproterona)' },
                  slug: 'medications/antiandrogens/cpa',
                  badge: { text: { 'zh-CN': '常用', en: 'Common', ja: '基本', ko: '일반', pt: 'Comum' }, variant: 'tip' },
                },
                {
                  label: '螺内酯',
                  translations: { en: 'Spironolactone', ja: 'スピロノラクトン', ko: '스피로노락톤', pt: 'Espironolactona' },
                  slug: 'medications/antiandrogens/spironolactone',
                },
                {
                  label: 'GnRH 激动剂',
                  translations: { en: 'GnRH Agonists', ja: 'GnRHアゴニスト', ko: 'GnRH 작용제', pt: 'Agonistas de GnRH' },
                  slug: 'medications/antiandrogens/gnrh-agonists',
                },
                {
                  label: '比卡鲁胺',
                  translations: { en: 'Bicalutamide', ja: 'ビカルタミド', ko: '비칼루타마이드', pt: 'Bicalutamida' },
                  slug: 'medications/antiandrogens/bicalutamide',
                  badge: { text: { 'zh-CN': '慎用', en: 'Caution', ja: '要注意', ko: '주의', pt: 'Cautela' }, variant: 'caution' },
                },
              ],
            },
            // ── 孕激素：扁平化，去掉推荐/替代中间层 ──
            {
              label: '孕激素',
              translations: { en: 'Progestogens', ja: 'プロゲストーゲン', ko: '프로게스토겐', pt: 'Progestógenos' },
              collapsed: true,
              items: [
                {
                  label: '概述',
                  ...
                  badge: { text: { 'zh-CN': '非必需', en: 'Optional', ja: '任意', ko: '선택', pt: 'Opcional' }, variant: 'note' },
                },
                {
                  label: '微粒化黄体酮',
                  translations: { en: 'Micronized Progesterone', ja: '微粉化プロゲステロン', ko: '미분화 프로게스테론', pt: 'Progesterona Micronizada' },
                  slug: 'medications/progestogens/progesterone',
                  badge: { text: { 'zh-CN': '首选', en: 'Preferred', ja: '推奨', ko: '권장', pt: 'Preferencial' }, variant: 'tip' },
                },
                {
                  label: '羟孕酮注射',
                  translations: { en: 'Hydroxyprogesterone', ja: 'ヒドロキシプロゲステロン', ko: '하이드록시프로게스테론', pt: 'Hidroxiprogesterona' },
                  slug: 'medications/progestogens/hydroxyprogesterone',
                },
                {
                  label: '地屈孕酮',
                  translations: { en: 'Dydrogesterone', ja: 'ジドロゲステロン', ko: '디드로게스테론', pt: 'Didrogesterona' },
